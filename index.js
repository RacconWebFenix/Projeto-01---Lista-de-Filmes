...
const filmes = [
    {
        ...
        imagemUrl: 'https://static.wikia.nocookie.net/marvel/images/1/15/P%C3%B4ster_de_Capit%C3%A3o_Am%C3%A9rica_O_Primeiro_Vingador.jpg/revision/latest?cb=20190329022429&path-prefix=pt-br',
    },
    {
        id: 2,
        nome: 'Capitã Marvel',
    ...
    },
    {
        ...
        imagemUrl: 'https://static.wikia.nocookie.net/marvel/images/0/0c/Homem_de_Ferro_2_p%C3%B4ster.jpg/revision/latest?cb=20170809144405&path-prefix=pt-br',
    },
];
...
app.post('/filmes', (req, res) => {
    ...
    if (!filme
        || !filme.nome
        || !filme.imagemUrl) {
        res.status(400).send({ message: 'Filme inválido. Certifique-se de que o body da requisição possui "nome" e "imagemUrl".' });
...
app.put('/filmes/:id', (req, res) => {
    ...
    if (filmeIndex < 0) {
        res.status(404).send({ message: 'O filme que você está tentando editar não foi encontrado.' });
